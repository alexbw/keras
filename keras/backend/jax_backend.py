...
# import keras.engine.base_layer as bl
...
def is_sparse(x):
    # TODO: sparsity not supported in JAX
    return False

def is_tensor(x):
    return isinstance(x, (DeferredNumpyArray,))
...
def placeholder(shape=None, ndim=None, dtype=None, sparse=False, name=None):
    ...
    if sparse:
        raise ValueError('Sparse types unsupported with NumPy backend')
    if None not in shape:
        x = np.zeros(shape=shape, dtype=dtype)
        x.name = name
    else:
        x = DeferredNumpyArray(shape=shape, dtype=dtype, name=name)
...
def random_uniform(shape, minval=0.0, maxval=1.0, dtype=None, seed=None):
    for _ in shape:
        if _ is None:
            raise ValueError('JAX Backend: randomness op with '
    ...
    return onp.random.uniform(
        size=shape,
        low=minval,
        high=maxval).astype(dtype)
...
def switch(condition, then_expression, else_expression):
    raise NotImplementedError('Should be a JAX conditional.')
...
def is_placeholder(x):
    raise NotImplementedError('Method "is_placeholder" for JAX backend currently not implemented')


def shape(x):
    raise NotImplementedError('Method "shape" for JAX backend currently not implemented')


def identity(x, name=None):
    raise NotImplementedError('Method "identity" for JAX backend currently not implemented')
...
def moving_average_update(x, value, momentum):
    raise NotImplementedError('Method "moving_average_update" for JAX backend currently not implemented')


def normalize_batch_in_training(x, gamma, beta,
                                reduction_axes, epsilon=1e-3):
    raise NotImplementedError('Method "normalize_batch_in_training" for JAX backend currently not implemented')


def batch_normalization(x, mean, var, beta, gamma, axis=-1, epsilon=1e-3):
    raise NotImplementedError('Method "batch_normalization" for JAX backend currently not implemented')


def slice(x, start, size):
    raise NotImplementedError('Method "slice" for JAX backend currently not implemented')


def batch_get_value(ops):
    raise NotImplementedError('Method "batch_get_value" for JAX backend currently not implemented')


def set_value(x, value):
    raise NotImplementedError('Method "set_value" for JAX backend currently not implemented')


def batch_set_value(tuples):
    raise NotImplementedError('Method "batch_set_value" for JAX backend currently not implemented')


def gradients(loss, variables):
    raise NotImplementedError('Method "gradients" for JAX backend currently not implemented')


def stop_gradient(variables):
    raise NotImplementedError('Method "stop_gradient" for JAX backend currently not implemented')


def sparse_categorical_crossentropy(target, output, from_logits=False, axis=-1):
    raise NotImplementedError('Method "sparse_categorical_crossentropy" for JAX backend currently not implemented')


def in_top_k(predictions, targets, k):
    raise NotImplementedError('Method "in_top_k" for JAX backend currently not implemented')
...
def random_normal(shape, mean=0.0, stddev=1.0, dtype=None, seed=None):
    ...
    # Returns
        A tensor.
    """
    raise NotImplementedError('Method "random_normal" for JAX backend currently not implemented')
...
def random_binomial(shape, p=0.0, dtype=None, seed=None):
    ...
    # Returns
        A tensor.
    """
    raise NotImplementedError('Method "random_binomial" for JAX backend currently not implemented')
...
def truncated_normal(shape, mean=0.0, stddev=1.0, dtype=None, seed=None):
    ...
    # Returns
        A tensor.
    """
    raise NotImplementedError('Method "truncated_normal" for JAX backend currently not implemented')


def local_conv1d(inputs, kernel, kernel_size, strides, data_format=None):
    raise NotImplementedError('Method "local_conv1d" for JAX backend currently not implemented')
...
def local_conv2d(inputs,
                 ...
                 output_shape,
                 data_format=None):
    raise NotImplementedError('Method "local_conv2d" for JAX backend currently not implemented')
